        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    var callbackUrl = Url.Action("ConfirmEmail", "User", new { userId = model.UserID, code = code }, protocol: Request.Url.Scheme);
                    await UserManager.SendEmailAsync(model.UserID, "Confirm your account", "Welcome to Social " + model.Name + " " + model.Lastname + " Please confirm your Social account by clicking <a href=\"" + callbackUrl + "\">here</a>");
